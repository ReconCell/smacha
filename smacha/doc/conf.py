...
# html_theme_options = {}
html_theme_options = {
    'canonical_url': 'https://reconcell.gitlab.io/smacha/smacha/'
...
man_pages = [
    (master_doc, 'smacha', 'smacha package API',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'smacha', 'smacha package API',
     author, 'smacha', 'SMACHA is a meta-scripting, templating, and code generation engine for rapid prototyping of ROS SMACH state machines.',
     'Miscellaneous'),
]
