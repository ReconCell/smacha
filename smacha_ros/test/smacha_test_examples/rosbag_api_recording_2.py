...
def main():
    ...
    sm.userdata.point_topic = 'smacha/rosbag_api_recording_1_point'
    sm.userdata.rate_1 = 10.0
    sm.userdata.pose = Pose()
    sm.userdata.pose_topic = 'smacha/rosbag_api_recording_1_pose'
    sm.userdata.rate_2 = 100.0
    sm.userdata.file_1 = '/tmp/rosbag_api_recording_2_bag_1.bag'
    sm.userdata.topics_1 = ['smacha/rosbag_api_recording_1_point']
    sm.userdata.file_2 = '/tmp/rosbag_api_recording_2_bag_2.bag'
    sm.userdata.topics_2 = ['smacha/rosbag_api_recording_1_pose']
